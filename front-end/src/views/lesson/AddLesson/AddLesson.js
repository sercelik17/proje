...
export function AddLesson(props) {
    ...
    return (
        <Dialog open={props.isOpen}>
            ...
            <DialogContent>
                <TextField onChange={onFormInputChange} name="isim" label="Name" fullWidth></TextField>
                <TextField onChange={onFormInputChange} name="tanim" label="Tanım" fullWidth></TextField>
                <TextField onChange={onFormInputChange} name="tip" label="Tip" fullWidth></TextField>
                <TextField onChange={onFormInputChange} name="kod" label="Kod" fullWidth></TextField>
                <Box sx={{ minWidth: 120 }}>
                ...
                <TextField onChange={onFormInputChange} name="academician_id" label="Academician" fullWidth></TextField>
            </DialogContent>
            <DialogActions>
